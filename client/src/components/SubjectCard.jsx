    ...
    return (
        <div className='card p-4 flex items-center justify-between'>
            <div className='flex flex-col'>
                ...
                <p className='text-xs text-slate-500 mt-1'>{subject.code} · Grade {subject.gradeLevels}</p>
            </div>
            <div className='flex items-center gap-2'>
                <button onClick={() => onEdit(subject)} className='p-2.5 bg-white/90 backdrop-blur-sm text-slate-700 
