...
const LoginLeftSide = () => {
  return (
    <div className='hidden md:flex w-1/2 bg-indigo-400 relative overflow-hidden border-r border-slate-200'>
      <div className='absolute -top-30 -left-30 w-72 h-72 bg-indigo-100/20 rounded-full blur-3xl'></div>
