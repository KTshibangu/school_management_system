            ...
            <div className='card p-5 sm:p-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    ...
                    <div>
                        ...
                        <input name='gradeLevels' required defaultValue={initialData?.gradeLevels} />
                    </div>
                    <div className='sm:col-span-2'>
                        <label className='block mb-2'>Term 1 Chapters</label>
                        <textarea name='term1Chapters' rows={3} defaultValue={initialData?.term1Chapters} className='resize-none'
                            placeholder='List Chapters (comma separated)' />
                    </div>
                    <div className='sm:col-span-2'>
                        <label className='block mb-2'>Term 2 Chapters</label>
                        <textarea name='term2Chapters' rows={3} defaultValue={initialData?.term2Chapters} className='resize-none'
                            placeholder='List Chapters (comma separated)' />
                    </div>
                    <div className='sm:col-span-2'>
