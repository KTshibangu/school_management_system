        ...
        <div className='w-full max-w-md animate-fade-in'>
          ...
          <form className='space-y-5' onSubmit={handleSubmit}>
            ...
            <div className='relative'>
              ...
              <input className='pr-11' type={showPassword ? 'text' : 'password'} onChange={(e) => setPassword(e.target.value)} placeholder='...........' required />
              <button className='absolute right-3 top-2/3 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors' 
              type='button'
            ...
            <button className='btn-primary w-full cursor-pointer py-3 bg-linear-to-r from-indigo-600 to-indigo-500 text-white
