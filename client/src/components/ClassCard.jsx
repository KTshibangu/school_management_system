    ...
    return (
        <div className='card p-4 flex items-center justify-between'>
            <div className='flex flex-col'>
                ...
                <p className='text-xs text-slate-500 mt-1'>Grade {classes.gradeLevels}</p>
            </div>
            <div className='flex items-center gap-2'>
                <button onClick={() => onEdit(classes)} className='p-2.5 bg-white/90 backdrop-blur-sm text-slate-700 
