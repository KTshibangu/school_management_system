...
export const SUBJECTS = [
  {
    ...
    code: 'MATH-8',
    gradeLevels: 8,
    term1Chapters: ['Chapter 1', 'Chapter 2', 'Chapter 3'],
    term2Chapters: ['Chapter 1', 'Chapter 2', 'Chapter 3'],
    term3Chapters: ['Chapter 1', 'Chapter 2', 'Chapter 3'],
    term4Chapters: ['Chapter 1', 'Chapter 2', 'Chapter 3'],
  },
  {
...
export const dummyTeacherData = [
  {
    ...
    subject: 'Mathematics',
    employeeCode: 'TCH-2024-011',
    classesAssigned: ['Grade 8A', 'Grade 9A'],
...
export const dummyStudentData = [
  {
    ...
    firstName: 'Liam',
    lastName: 'Botha',
    parentName: 'Grace Botha',
    parentPhone: '0740543210',
  ...
  },
  {
    ...
    firstName: 'Amara',
    lastName: 'Osei',
    parentName: 'Didi Osei',
    parentPhone: '0766544211',
  ...
  },
  {
    ...
    firstName: 'Ethan',
    lastName: 'Pillay',
    parentName: 'Avin Pillay',
    parentPhone: '0812093349',
...
export const dummyAssignmentData = [
  {
    ...
    className: 'Grade 10A',
    description:
      'Complete all exercises on quadratic equations from Chapter 5. Show all working.',
    term: 'Term 1',
    assessmentType: 'Test',
  ...
  },
  {
    ...
    className: 'Grade 11A',
    description:
      'Write a lab report based on the pendulum experiment conducted in class. Include hypothesis, method, results, and conclusion.',
  ...
  },
  {
    ...
    className: 'Grade 10A',
    description:
      "Analyse the structure, tone, and themes of Shakespeare's Sonnet 18. Minimum 600 words.",
  ...
  },
  {
    ...
    className: 'Grade 12A',
    description:
      'Complete the revision exercises covering calculus, probability, and statistics in preparation for the Term 2 exam.',
...
export const dummyEventData = [
  {
    ...
    description:
      'End of term prize giving ceremony for all students. Parents are welcome to attend.',
    type: 'Assembly',
    audience: 'ALL',
  ...
  },
  {
    ...
    description:
      'Annual inter-house athletics competition for Grade 8 and 9 learners.',
    type: 'Sports Day',
    audience: 'STUDENTS',
  ...
  },
  {
    ...
    description:
      'Professional development session covering new CAPS curriculum updates.',
    type: 'Workshop',
    audience: 'TEACHERS',
    location: 'Staff Room',
  ...
  },
  {
    ...
    description:
      'Educational trip to the Durban Career Expo for Grade 10 students.',
    type: 'Trip',
    audience: 'Grade 10',
    location: 'Durban ICC',
...
export function getGradeDisplay(percentage) {
  ...
  if (percentage >= 70)
    return { grade: 'B', className: 'bg-blue-100 text-blue-700' };
  if (percentage >= 60) return { grade: 'C', className: 'badge-warning' };
  if (percentage >= 50)
    return { grade: 'D', className: 'bg-orange-100 text-orange-700' };
